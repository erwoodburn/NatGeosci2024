...
dir_out_p=sprintf("/pscratch/sd/w/woodburn/er_deltat_fall22/forcing/precip_sum.baseline_wy%i.txt",wy)
dir_out_s=sprintf("/pscratch/sd/w/woodburn/er_deltat_fall22/forcing/snowfall_sum.baseline_wy%i.txt",wy)
dir_out_r=sprintf("/pscratch/sd/w/woodburn/er_deltat_fall22/forcing/rainfall_sum.baseline_wy%i.txt",wy)
...
dir_out_all=sprintf("/pscratch/sd/w/woodburn/er_deltat_fall22/forcing/annual_sums.precip_snowfall_rainfall.baseline_wy%i.txt",wy,wy)
